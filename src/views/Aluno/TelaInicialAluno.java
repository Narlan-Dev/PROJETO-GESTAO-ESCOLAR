...
public class TelaInicialAluno extends javax.swing.JInternalFrame {
    private static TelaInicialAluno telaDasSalas;
    
    public static TelaInicialAluno getInstancia(){
        if(telaDasSalas == null){
            telaDasSalas = new TelaInicialAluno();
        }
        return telaDasSalas;
    }
